...
class StoreScheduleRequest extends FormRequest
{
    ...
    public function validated($key = null, $default = null)
    {
        ...
        if (is_array($validated)) {
            ...
            $content = ($validated['content'] ?? null) ?: ($validated['title'] ?? null) ?: '';
            $validated['content'] = $content;

            // Normalize date
            $date = ($validated['event_date'] ?? null) ?: ($validated['date'] ?? null) ?: now()->toDateString();
    ...
    {
        return [
            'module_type.required' => 'Loại chương trình không được để trống.',
