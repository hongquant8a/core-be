...
/**
 * Routes notification scoped cho module Meeting.
 * - Event configs + schedules (admin config theo org).
 * - Logs + stats (lịch sử gửi chỉ trong events của module + org hiện tại).
 * Middleware `notification.module:meeting` set module_key vào request context.
 */
Route::middleware('notification.module:meeting')->group(function () {
    // Admin event config
