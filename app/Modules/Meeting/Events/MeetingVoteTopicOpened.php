...
class MeetingVoteTopicOpened implements ShouldBroadcastNow
{
    ...
    public function broadcastWith(): array
    {
        return [
            ...
            'is_vote_change_allowed' => (bool) $this->topic->is_vote_change_allowed,
            'is_voting_result_hidden_until_end' => (bool) $this->topic->is_voting_result_hidden_until_end,
            'calculate_by_total_delegates' => (bool) $this->topic->calculate_by_total_delegates,
            'calculate_by_present_delegates' => (bool) $this->topic->calculate_by_present_delegates,
