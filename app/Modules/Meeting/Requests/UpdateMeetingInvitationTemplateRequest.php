...
class UpdateMeetingInvitationTemplateRequest extends FormRequest
{
    ...
    {
        return [
            'name' => ['description' => 'Tên template giấy mời.', 'example' => 'Mẫu giấy mời họp'],
            'description' => ['description' => 'Mô tả ngắn template.', 'example' => 'Mẫu giấy mời chuẩn cho kỳ họp.'],
            'file' => ['description' => 'File .docx có placeholder ${var_name}. Xem cheatsheet ở /meeting-invitation-templates/variables.'],
