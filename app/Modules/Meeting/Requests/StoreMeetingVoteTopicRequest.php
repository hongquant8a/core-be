...
class StoreMeetingVoteTopicRequest extends FormRequest
{
    ...
    public function bodyParameters(): array
    {
        return [
            ...
            'description' => ['description' => 'Nội dung diễn giải hiển thị trên popup biểu quyết (optional).', 'example' => 'Biểu quyết thông qua nghị quyết phân bổ ngân sách 2026.'],
            'duration_minutes' => ['description' => 'Thời lượng phiên biểu quyết tính bằng phút (FE đếm ngược).', 'example' => 5],
