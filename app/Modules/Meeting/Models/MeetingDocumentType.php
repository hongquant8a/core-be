...
class MeetingDocumentType extends TenantModel
{
    use HasFactory;
    ...
    {
        static::creating(fn (MeetingDocumentType $model) => $model->created_by = $model->updated_by = auth()->id());
        static::updating(fn (MeetingDocumentType $model) => $model->updated_by = auth()->id());
    }
