...
class MeetingAttendeeGroup extends TenantModel
{
    use HasFactory;
    ...
    {
        static::creating(fn (MeetingAttendeeGroup $model) => $model->created_by = $model->updated_by = auth()->id());
        static::updating(fn (MeetingAttendeeGroup $model) => $model->updated_by = auth()->id());
    }
