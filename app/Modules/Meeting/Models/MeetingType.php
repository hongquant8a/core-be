...
class MeetingType extends TenantModel
{
    use HasFactory;
    ...
    {
        static::creating(fn (MeetingType $model) => $model->created_by = $model->updated_by = auth()->id());
        static::updating(fn (MeetingType $model) => $model->updated_by = auth()->id());
    }
