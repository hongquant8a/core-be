...
use App\Modules\TaskAssignment\Controllers\TaskAssignmentTypeController;
...
Route::delete('/bulk-delete', [TaskAssignmentTypeController::class, 'bulkDestroy'])->middleware('permission:task-assignment-types.destroy,web');
Route::patch('/bulk-status', [TaskAssignmentTypeController::class, 'bulkUpdateStatus'])->middleware('permission:task-assignment-types.update,web');
Route::get('/stats', [TaskAssignmentTypeController::class, 'stats'])->middleware('permission:task-assignment-types.index,web');
Route::get('/', [TaskAssignmentTypeController::class, 'index'])->middleware('permission:task-assignment-types.index,web');
Route::get('/{taskAssignmentType}', [TaskAssignmentTypeController::class, 'show'])->middleware('permission:task-assignment-types.index,web');
...
Route::patch('/{taskAssignmentType}/status', [TaskAssignmentTypeController::class, 'changeStatus'])->middleware('permission:task-assignment-types.update,web');
