...
/**
 * Routes notification scoped cho module Beneficiary.
 * - Event configs + schedules (admin config theo org) — cán bộ phường tự cấu hình
 *   "nhắc trước N ngày" cho lịch viếng thăm (beneficiary_visit_reminder_before/on/after).
 * - Logs + stats (lịch sử gửi chỉ trong events của module + org hiện tại).
 * Middleware `notification.module:beneficiary` set module_key vào request context.
 */
Route::middleware('notification.module:beneficiary')->group(function () {
    // Admin event config
