...
class BulkDestroyDependentRequest extends BaseRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'ids.min' => 'Phải chọn ít nhất 1 thân nhân.',
        ];
    }
    ...
    {
        return [
            'ids' => ['description' => 'Danh sách ID thân nhân cần xóa.', 'example' => [1, 2, 3]],
        ];
    }
