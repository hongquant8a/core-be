...
Route::get('/import-template', [PermissionController::class, 'importTemplate'])->middleware('permission:permissions.import,web');
Route::delete('/bulk-delete', [PermissionController::class, 'bulkDestroy'])->middleware('permission:permissions.bulkDestroy,web');
