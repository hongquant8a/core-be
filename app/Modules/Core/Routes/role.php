...
Route::get('/import-template', [RoleController::class, 'importTemplate'])->middleware('permission:roles.import,web');
Route::delete('/bulk-delete', [RoleController::class, 'bulkDestroy'])->middleware('permission:roles.bulkDestroy,web');
